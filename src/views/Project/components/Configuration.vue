    ...
    <div class="configuration">
        <el-tabs v-model="activeName" type="border-card">
            ...
            <el-tab-pane label="下载参数配置" name="下载参数配置">
                <el-form ref="download_params_form" :model="download_params_form" label-width="200px">
                    ...
                    <el-form-item label="连接超时时间" >
                        <el-input v-model="download_params_form.timeout" placeholder="单位 / 秒" style="width:300px"></el-input>
                    </el-form-item>
                    <el-form-item label="下载速度">
                        <el-input v-model="download_params_form.download_speed" placeholder="单位 / KB" style="width:300px"></el-input>
                    </el-form-item>
                    <el-form-item label="单个文件下载最大的大小">
                        <el-input v-model="download_params_form.max_file_size" placeholder="单位 / MB" style="width:300px"></el-input>
                    </el-form-item>
                    <el-form-item label="DNS缓存的大小">
                        <el-input v-model="download_params_form.DNS_size" placeholder="单位 / MB" style="width:300px"> </el-input>
                    </el-form-item>
            ...
            <el-tab-pane label="资源抽取配置" name="资源抽取配置">
                <el-form ref="resource_extraction_form" :model="resource_extraction_form" label-width="200px">
                    ...
                    <el-form-item label="关键字限定">
                        <el-input v-model="resource_extraction_form.keyword" placeholder="多个关键词空格分开" id="keyword" style="width:600px">
                            <el-select v-model="resource_extraction_form.keyword_logic" slot="prepend" placeholder="请选择" style="width:100px">
            ...
            <el-tab-pane label="存储模式配置" name="存储模式配置">
                <el-form ref="storage_management_form" :model="storage_management_form" label-width="200px">
                    ...
                    <el-form-item label="redis选项">
                        <el-input placeholder="请输入内容" v-model="storage_management_form.redis.ip" style="margin:5px 0px; width:600px" >
                            <template slot="prepend">地址</template>
                        </el-input><br />
                        <el-input placeholder="请输入内容" v-model="storage_management_form.redis.port"  style="margin:5px 0px; width:600px">
                            <template slot="prepend">端口</template>
                        </el-input><br />
                        <el-select v-model="storage_management_form.redis.type" filterable placeholder="请选择" >
                            <template slot="prefix"> <span class = 'prefixSlot'>类型</span></template>
                            <el-option key="set" label="集合" value="set"> </el-option>
                            <el-option key="list" label="列表" value="list"> </el-option>
                        </el-select>
                    </el-form-item>
                    <el-form-item label="内容存储">
                          <el-input placeholder="请输入内容" v-model="storage_management_form.storage_content.ip" style="margin:5px 0px ; width:600px">
                                <template slot="prepend">地址</template>
                            </el-input><br />
                            <el-input placeholder="请输入内容" v-model="storage_management_form.storage_content.port"  style="margin:5px 0px; width:600px">
                                <template slot="prepend">端口</template>
                            </el-input><br />
                            <el-input placeholder="请输入内容" v-model="storage_management_form.storage_content.username"  style="margin:5px 0px; width:600px">
                                <template slot="prepend">用户</template>
                            </el-input><br />
                            <el-input placeholder="请输入内容" v-model="storage_management_form.storage_content.password"  style="margin:5px 0px; width:600px">
                                <template slot="prepend">密码</template>
                            </el-input><br />
                             <el-input placeholder="请输入内容" v-model="storage_management_form.storage_content.dbname"  style="margin:5px 0px; width:600px">
                                <template slot="prepend">库名</template>
                            </el-input><br />
                            <el-input placeholder="请输入内容" v-model="storage_management_form.storage_content.tablename" style="margin:5px 0px; width:600px">
                    ...
                    <el-form-item label="文件存储方式">
                        ...
                        <div v-if="storage_management_form.storage_type == 1">
                            <el-input placeholder="请输入内容" v-model="storage_management_form.storage_type_1.dirs"  style="margin:5px 0px; width:600px">
                                <template slot="prepend">本地路径</template>
                            </el-input>
                        </div>
                        <div v-if="storage_management_form.storage_type == 2">
                            <el-input placeholder="请输入内容" v-model="storage_management_form.storage_type_2.ip"  style="margin:5px 0px; width:600px">
                                <template slot="prepend">地址</template>
                            </el-input><br />
                            <el-input placeholder="请输入内容" v-model="storage_management_form.storage_type_2.port"  style="margin:5px 0px; width:600px">
                                <template slot="prepend">端口</template>
                            </el-input><br />
                            <el-input placeholder="请输入内容" v-model="storage_management_form.storage_type_2.username"  style="margin:5px 0px; width:600px">
                                <template slot="prepend">用户</template>
                            </el-input><br />
                            <el-input placeholder="请输入内容" v-model="storage_management_form.storage_type_2.password"  style="margin:5px 0px; width:600px">
                                <template slot="prepend">密码</template>
                            </el-input>
                        </div>
                        <div v-if="storage_management_form.storage_type == 3">
                            <el-input placeholder="请输入内容" v-model="storage_management_form.storage_type_3.interface_address"  style="margin:5px 0px; width:600px">
                                <template slot="prepend">上传接口</template>
                            </el-input>
                        </div>
                        <div v-if="storage_management_form.storage_type == 4">
                            <el-input placeholder="请输入内容" v-model="storage_management_form.storage_type_4.ip" style="margin:5px 0px; width:600px">
                                <template slot="prepend">地址</template>
                            </el-input><br />
                            <el-input placeholder="请输入内容" v-model="storage_management_form.storage_type_4.port"  style="margin:5px 0px; width:600px">
                                <template slot="prepend">端口</template>
                            </el-input><br />
                            <el-input placeholder="请输入内容" v-model="storage_management_form.storage_type_4.username"  style="margin:5px 0px; width:600px">
                                <template slot="prepend">用户</template>
                            </el-input><br />
                            <el-input placeholder="请输入内容" v-model="storage_management_form.storage_type_4.password"  style="margin:5px 0px; width:600px">
                                <template slot="prepend">密码</template>
                            </el-input><br />
                             <el-input placeholder="请输入内容" v-model="storage_management_form.storage_type_4.dbname"  style="margin:5px 0px; width:600px">
                                <template slot="prepend">库名</template>
                            </el-input><br />
                            <el-input placeholder="请输入内容" v-model="storage_management_form.storage_type_4.tablename">
                                <template slot="prepend">表名</template>
                            </el-input>
                        </div>
                    </el-form-item>
